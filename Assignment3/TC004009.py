...
class TC004009(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c004009(self):
        ...
        driver.find_element_by_id("course-info-container-59-3").click()
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776780584790_991").click()
        driver.find_element_by_id("id_grade_modgrade_point").clear()
        driver.find_element_by_id("id_grade_modgrade_point").send_keys("!!!")

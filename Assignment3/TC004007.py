...
class TC004007(unittest.TestCase):
    ...
    def test_t_c004007(self):
        ...
        driver.find_element_by_xpath("//div[@id='yui_3_18_1_1_1776780182883_12']/button/i").click()
        driver.find_element_by_id("password").click()
        driver.find_element_by_id("loginbtn").click()
        driver.find_element_by_xpath("//div[@id='course-info-container-59-3']/div/div").click()
        driver.find_element_by_xpath("//div[@id='yui_3_18_1_1_1776780191088_32']/a/span[3]/span[2]").click()
        driver.find_element_by_xpath("//li[@id='module-807']/div").click()
        driver.find_element_by_xpath("//div[@id='yui_3_18_1_1_1776780194050_31']/div[2]/div[2]/div/div/a").click()
        driver.find_element_by_link_text("Settings").click()
        driver.find_element_by_id("collapseElement-7").click()
        driver.find_element_by_xpath("//div[@id='fitem_fgroup_id_grade']/div[2]/fieldset/div/label[3]").click()
        driver.find_element_by_id("yui_3_18_1_1_1776780204397_985").click()
        driver.find_element_by_id("yui_3_18_1_1_1776780204397_987").click()
        driver.find_element_by_id("id_grade_modgrade_point").clear()
        driver.find_element_by_id("id_grade_modgrade_point").send_keys("-5")
        driver.find_element_by_id("id_gradepass").click()
        driver.find_element_by_id("id_gradepass").clear()
        driver.find_element_by_id("id_gradepass").send_keys("-10")
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776780222267_970").click()
        driver.find_element_by_id("yui_3_18_1_1_1776780222267_970").click()

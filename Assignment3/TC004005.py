...
class TC004005(unittest.TestCase):
    ...
    def test_t_c004005(self):
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776779808370_12").click()
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776779864387_987").click()
        driver.find_element_by_id("id_gradepass").clear()
        driver.find_element_by_id("id_gradepass").send_keys("abc")
        ...
        try: self.assertEqual("You must enter a number here.", driver.find_element_by_id("id_error_gradepass").text)

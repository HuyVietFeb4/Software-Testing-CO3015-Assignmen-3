...
class TC004003(unittest.TestCase):
    ...
    def test_t_c004003(self):
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776777792726_1019").click()
        ...
        try: self.assertEqual("5", driver.find_element_by_id("id_timelimit_number").get_attribute("value"))

...
class TC004006(unittest.TestCase):
    ...
    def test_t_c004006(self):
        ...
        driver.find_element_by_id("id_gradepass").send_keys("140")
        ...
        driver.find_element_by_id("id_error_gradepass").click()
        try: self.assertEqual("The grade to pass can not be greater than the maximum possible grade 100", driver.find_element_by_id("yui_3_18_1_1_1776780065819_1032").text)

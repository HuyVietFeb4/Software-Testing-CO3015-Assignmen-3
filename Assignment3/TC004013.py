...
class TC004013(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c004013(self):
        ...
        driver.find_element_by_xpath("//li[@id='module-807']/div/div[2]").click()
        driver.find_element_by_xpath("//div[@id='yui_3_18_1_1_1776781322719_31']/div[2]/div/div/a").click()
        driver.find_element_by_link_text("Settings").click()
        driver.find_element_by_id("collapseElement-7").click()
        driver.find_element_by_id("yui_3_18_1_1_1776781328148_993").click()
        driver.find_element_by_id("id_grade_modgrade_point").clear()
        driver.find_element_by_id("id_grade_modgrade_point").send_keys("1000")

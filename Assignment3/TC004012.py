...
class TC004012(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c004012(self):
        driver = self.driver
        driver.get("https://school.moodledemo.net/")
        driver.find_element_by_id("yui_3_18_1_1_1776781142929_12").click()
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776781167536_987").click()
        driver.find_element_by_id("id_gradepass").clear()
        driver.find_element_by_id("id_gradepass").send_keys("150")
        ...
        driver.find_element_by_xpath("//div[@id='fitem_id_gradepass']/div[2]").click()
        try: self.assertEqual("The grade to pass can not be greater than the maximum possible grade 100", driver.find_element_by_id("id_error_gradepass").text)

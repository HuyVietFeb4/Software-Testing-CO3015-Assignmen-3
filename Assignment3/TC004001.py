...
class TC004001(unittest.TestCase):
    ...
    def test_t_c004001(self):
        ...
        driver.find_element_by_xpath("//div[@id='yui_3_18_1_1_1776777386540_12']/button/i").click()
        ...
        driver.find_element_by_id("id_timelimit_number").send_keys("-1")
        ...
        driver.find_element_by_xpath("//div[@id='fitem_id_timelimit']/div[2]").click()
        try: self.assertEqual("This duration cannot be negative.", driver.find_element_by_id("id_error_timelimit").text)

...
class TC004014(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c004014(self):
        ...
        driver.find_element_by_id("yui_3_18_1_1_1776781443520_988").click()
        driver.find_element_by_id("id_gradepass").clear()
        driver.find_element_by_id("id_gradepass").send_keys("a")
